  ...
  return (
    <main>
      ...
      <p>
        ...
        interfaces, and emancipatory politics. I am interested in the potential
        of computing as a medium for thought, as a tool for collective action,
        and as a means of emancipation.
      </p>
      ...
      <p>
        ...
        <i>knowledge organisation infrastructure</i> and an engineer/researcher
        at <a href="https://websim.ai">websim</a>. I am also part of the nascent{" "}
        <a href="https://libcomp.org/">Liberatory Computing</a> collective,
        occasional collaborator with{" "}
        <a href="https://economicspace.agency/">ECSA</a> and a co-organiser of
        the <a href="https://canvasprotocol.org/">OCWG</a>.
      </p>

      <h2>Get in touch</h2>
      <p>
        I am on Bsky{" "}
        <a href="https://bsky.app/profile/orionreed.bsky.social">@OrionReed</a>,
        Twitter <a href="https://twitter.com/OrionReedOne">@OrionReedOne</a>,
        Mastodon <a href="https://hci.social/@orion">@orion@hci.social</a> and
        GitHub <a href="https://github.com/orionreed">@orionreed</a>. You can
      ...
      <ol reversed>
        ...
        <li>
          <a href="https://twitter.com/OrionReedOne/status/1772271156373905465">
            DOM to canvas translation (it's that button in the top right of this
            page)
          </a>
        </li>
        <li>

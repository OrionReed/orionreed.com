...
import { lazy, Signal, type SignalOptions, type Val, valFn } from "../signal";
...
/** Writable Hsl — overrides each field-lens to its writable counterpart. */
export interface Hsl_W extends Wr<Hsl> {
  get h(): Writable<Num>;
  get s(): Writable<Num>;
  get l(): Writable<Num>;
}

// network.test.ts — semantics of the `network` primitive.
//
// Covers:
...
import { batch, effect, type Signal, network, signal } from "../index";

describe("network — basic semantics", () => {
...
describe("network — auto-batched commit", () => {
...
describe("network — self-exclusion edge cases", () => {
  ...
  it("only the writing network is excluded — other networks fire", () => {
    const a = signal(0);
    let runsA = 0;
    let runsB = 0;
